var PlayersManager = require('./playersServerSideManager'),
    PipeManager = require('./pipeManager'),
    CollisionEngine = require('./collisionManager'),
    enums = require('./enums'),
...
function startGameLoop() {
    ...
    _timer = setInterval(function () {
        ...
        _playersManager.updatePlayers(elapsedTime);

        // Update pipes
        _pipeManager.updatePipes(elapsedTime);
